...
from rpcclient.core.structs.generic import UNIX_PATH_MAX, gid_t, in_addr, long, mode_t, short, st_flags, time_t, \
    u_char, u_int32_t, u_short, uid_t, uint8_t, uint32_t, uint64_t
