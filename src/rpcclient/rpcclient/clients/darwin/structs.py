...
in_sockinfo = Struct(
    ...
    "insi_faddr" / Union(None, "ina_46" / in4in6_addr, "ina_6" / in6_addr),
    "insi_laddr" / Union(None, "ina_46" / in4in6_addr, "ina_6" / in6_addr),
    "insi_v4"
    / Struct(
        "in4_tos" / u_char,
    ),
...
un_sockinfo = Struct(
    ...
    "unsi_addr" / Union(None, "ua_sun" / sockaddr_un_raw, "ua_dummy" / Bytes(SOCK_MAXADDRLEN)),
    "unsi_caddr" / Union(None, "ua_sun" / sockaddr_un_raw, "ua_dummy" / Bytes(SOCK_MAXADDRLEN)),
)
...
dyld_image_info_t = Struct("imageLoadAddress" / Int64ul, "imageFilePath" / Int64ul, "imageFileModDate" / Int64ul)
...
uuid_command_t = Struct("uuid" / Array(16, Int8ul))

build_tool_version = Struct("tool" / Int32ul, "version" / Int32ul)
...
fat_header = Struct("magic" / Hex(Int32ul), "nfat_arch" / Hex(Int32ub), "archs" / Array(this.nfat_arch, fat_arch))
