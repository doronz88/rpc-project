...
class CFPreferences:
    ...
    def set(
        ...
        self._client.symbols.CFPreferencesSetValue(
            self._client.cf(key),
            self._client.cf(value),
            self._client.cf(application_id),
            self._client.cf(username),
    ...
    def sync(
        ...
        if not self._client.symbols.CFPreferencesSynchronize(
            self._client.cf(application_id), self._client.cf(username), self._client.cf(hostname)
        ):
