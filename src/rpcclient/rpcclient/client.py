...
class Client:
    ...
    def get_dummy_block(self) -> typing.Union[Symbol, int]:
    ...
    def spawn(self, argv: typing.List[str] = None, envp: typing.List[str] = None, stdin: io_or_str = sys.stdin,
        ...
        with self._protocol_lock:
            ...
            try:
                ...
                self._sock._sock.setblocking(True)
    ...
    def reconnect(self):
        ...
        with self.reconnect_lock:
            with self._protocol_lock:
                self._close()
                s = self._create_socket_cb()
                self._sock = ProtoSocket(s)
