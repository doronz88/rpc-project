...
void call_function(intptr_t address, size_t va_list_index, size_t argc, Rpc__Argument **p_argv, Rpc__ReplyCall *resp);
...
const rpc_routine_entry_t rpc_routines[RPC__PROTOCOL_CONSTANTS__RPC_MAX_REQ_MSG_ID] = {
    [RPC__MSG_ID__REQ_DLOPEN] = {.routine = routine_dlopen,
                                 .request_descriptor = &rpc__request_dlopen__descriptor,
                                 .reply_descriptor = &rpc__reply_dlopen__descriptor,
                                 .name = "DLOPEN",
                                 .cleanup = NULL

    },
    [RPC__MSG_ID__REQ_DLCLOSE] = {.routine = routine_dlclose,
                                  .request_descriptor = &rpc__request_dlclose__descriptor,
                                  .reply_descriptor = &rpc__reply_dlclose__descriptor,
                                  .name = "DLCLOSE",
                                  .cleanup = NULL},
    [RPC__MSG_ID__REQ_DLSYM] = {.routine = routine_dlsym,
                                .request_descriptor = &rpc__request_dlsym__descriptor,
                                .reply_descriptor = &rpc__reply_dlsym__descriptor,
                                .name = "DLSYM",
                                .cleanup = NULL},
    [RPC__MSG_ID__REQ_PEEK] = {.routine = routine_peek,
                               .request_descriptor = &rpc__request_peek__descriptor,
                               .reply_descriptor = &rpc__reply_peek__descriptor,
                               .name = "PEEK",
                               .cleanup = cleanup_peek},
    [RPC__MSG_ID__REQ_POKE] = {.routine = routine_poke,
                               .request_descriptor = &rpc__request_poke__descriptor,
                               .reply_descriptor = &rpc__reply_poke__descriptor,
                               .name = "POKE",
                               .cleanup = NULL},
    [RPC__MSG_ID__REQ_CALL] = {.routine = routine_call,
                               .request_descriptor = &rpc__request_call__descriptor,
                               .reply_descriptor = &rpc__reply_call__descriptor,
                               .name = "CALL",
                               .cleanup = NULL},
    [RPC__MSG_ID__REQ_LIST_DIR] = {.routine = routine_listdir,
                                   .request_descriptor = &rpc__request_list_dir__descriptor,
                                   .reply_descriptor = &rpc__reply_list_dir__descriptor,
                                   .name = "LISTDIR",
                                   .cleanup = cleanup_listdir},
    [RPC__MSG_ID__REQ_CLOSE_CLIENT] =
        {
            .routine = routine_close_client,
            .request_descriptor = &rpc__request_close_client__descriptor,
            .reply_descriptor = &rpc__reply_close_client__descriptor,
            .name = "CLOSE_CLIENT",
            .cleanup = NULL,
        },
    [RPC__MSG_ID__REQ_EXEC] =
        {
            .routine = routine_exec,
            .request_descriptor = &rpc__request_exec__descriptor,
            .reply_descriptor = &rpc__reply_exec__descriptor,
            .name = "EXEC",
            .cleanup = NULL,
        },
...
#if __APPLE__
    [RPC__MSG_ID__REQ_DUMMY_BLOCK] = {.routine = routine_get_dummy_block,
                                      .request_descriptor = &rpc__request_dummy_block__descriptor,
                                      .reply_descriptor = &rpc__reply_dummy_block__descriptor,
                                      .name = "DUMMY_BLOCK",
                                      .cleanup = NULL},
    [RPC__MSG_ID__REQ_SHOW_CLASS] = {.routine = routine_show_class,
                                     .request_descriptor = &rpc__request_show_class__descriptor,
                                     .reply_descriptor = &rpc__reply_show_class__descriptor,
                                     .name = "SHOW_CLASS",
                                     .cleanup = cleanup_show_class},
    [RPC__MSG_ID__REQ_SHOW_OBJECT] = {.routine = routine_show_object,
                                      .request_descriptor = &rpc__request_show_object__descriptor,
                                      .reply_descriptor = &rpc__reply_show_object__descriptor,
                                      .name = "SHOW_OBJECT",
                                      .cleanup = cleanup_show_object},
    [RPC__MSG_ID__REQ_GET_CLASS_LIST] = {.routine = routine_get_class_list,
                                         .request_descriptor = &rpc__request_get_class_list__descriptor,
                                         .reply_descriptor = &rpc__reply_get_class_list__descriptor,
                                         .name = "GET_CLASS_LIST",
...
static void reply_error(Rpc__RpcMessage *out, const char *fmt, ...) {
    Rpc__ReplyError err = RPC__REPLY_ERROR__INIT;
    ...
    const size_t size = rpc__reply_error__get_packed_size(&err);
    ...
    rpc__reply_error__pack(&err, data);
 ...
 *                      It is expected to conform to the Rpc__RequestDlopen structure.
 ...
 */
static routine_status_t routine_dlopen(const ProtobufCMessage *in_msg, ProtobufCMessage **out_msg) {
    const Rpc__RequestDlopen *request_dlopen = (const Rpc__RequestDlopen *) in_msg;
    Rpc__ReplyDlopen *reply_dlopen = malloc(sizeof *reply_dlopen);
    CHECK(reply_dlopen != NULL);
    rpc__reply_dlopen__init(reply_dlopen);
 ...
 *               This message is expected to be of type Rpc__RequestDlclose.
 ...
 *                operation into it. This message is of type Rpc__ReplyDlclose.
...
routine_status_t routine_dlclose(const ProtobufCMessage *in_msg, ProtobufCMessage **out_msg) {
    const Rpc__RequestDlclose *request_dlclose = (const Rpc__RequestDlclose *) in_msg;
    Rpc__ReplyDlclose *reply_dlclose = malloc(sizeof *reply_dlclose);
    CHECK(reply_dlclose != NULL);
    rpc__reply_dlclose__init(reply_dlclose);
 ...
 *            Rpc__RequestDlsym request. This message contains the required
 ...
 *             message (Rpc__ReplyDlsym) will be stored after successful
...
routine_status_t routine_dlsym(const ProtobufCMessage *in_msg, ProtobufCMessage **out_msg) {
    const Rpc__RequestDlsym *request_dlsym = (const Rpc__RequestDlsym *) in_msg;
    Rpc__ReplyDlsym *reply_dlsym = malloc(sizeof *reply_dlsym);
    CHECK(reply_dlsym != NULL);
    rpc__reply_dlsym__init(reply_dlsym);
 ...
 *               This must be of type Rpc__RequestPeek.
 ...
 */
static routine_status_t routine_peek(const ProtobufCMessage *in_msg, ProtobufCMessage **out_msg) {
    const Rpc__RequestPeek *request_peek = (const Rpc__RequestPeek *) in_msg;
    Rpc__ReplyPeek *reply_peek = malloc(sizeof *reply_peek);
    CHECK(reply_peek != NULL);
    rpc__reply_peek__init(reply_peek);
 ...
 *
 * @param in_msg The input ProtobufCMessage containing the request data.
 *               This is expected to be of type Rpc__RequestPoke.
 * @param out_msg A pointer to a ProtobufCMessage pointer that will be set
 *                to the allocated reply message of type Rpc__ReplyPoke.
 *
 * @return ROUTINE_SUCCESS if the operation completes successfully.
 ...
 */
static routine_status_t routine_poke(const ProtobufCMessage *in_msg, ProtobufCMessage **out_msg) {
    const Rpc__RequestPoke *request_poke = (const Rpc__RequestPoke *) in_msg;
    Rpc__ReplyPoke *reply_poke = malloc(sizeof *reply_poke);
    CHECK(reply_poke != NULL);
    rpc__reply_poke__init(reply_poke);
 ...
 *
 * @param in_msg Pointer to the input `ProtobufCMessage`, expected to be of type `Rpc__RequestCall`.
 ...
 */
static routine_status_t routine_call(const ProtobufCMessage *in_msg, ProtobufCMessage **out_msg) {
    const Rpc__RequestCall *request_call = (const Rpc__RequestCall *) in_msg;
    Rpc__ReplyCall *reply_poke = malloc(sizeof *reply_poke);
    CHECK(reply_poke != NULL);
    rpc__reply_call__init(reply_poke);
    *out_msg = (ProtobufCMessage *) reply_poke;

#ifdef __ARM_ARCH_ISA_A64
    // Allocate nested return-registers on heap so it survives until packing.
    Rpc__ReturnRegistersArm *regs = malloc(sizeof *regs);
    CHECK(regs != NULL);
    rpc__return_registers_arm__init(regs);
    reply_poke->arm_registers = regs;
    reply_poke->return_values_case = RPC__REPLY_CALL__RETURN_VALUES_ARM_REGISTERS;
#else
    reply_poke->return_values_case = RPC__REPLY_CALL__RETURN_VALUES_RETURN_VALUE;
#endif
...
static routine_status_t routine_close_client(const ProtobufCMessage *in_msg, ProtobufCMessage **out_msg) {
    (void) in_msg;
    Rpc__ReplyCloseClient *reply_close = malloc(sizeof *reply_close);
    CHECK(reply_close != NULL);
    rpc__reply_close_client__init(reply_close);
 ...
 *               Must be of type `Rpc__RequestListDir` and include a valid `path`.
 * @param out_msg Output Protobuf message containing the results of the directory listing.
 *                Will be populated as a `Rpc__ReplyListDir` message with directory entries.
 *
 ...
 */
static routine_status_t routine_listdir(const ProtobufCMessage *in_msg, ProtobufCMessage **out_msg) {
    const Rpc__RequestListDir *request_list_dir = (const Rpc__RequestListDir *) in_msg;
    Rpc__ReplyListDir *reply_list_dir = malloc(sizeof *reply_list_dir);
    DIR *dirp = NULL;
    CHECK(reply_list_dir != NULL);
    rpc__reply_list_dir__init(reply_list_dir);
    *out_msg = (ProtobufCMessage *) reply_list_dir;
    ...
    reply_list_dir->dir_entries = (Rpc__DirEntry **) calloc(entry_count, sizeof(Rpc__DirEntry *));
    ...
    while ((entry = readdir(dirp)) != NULL && idx < entry_count) {
        ...
        Rpc__DirEntryStat *s_stat = NULL;
        Rpc__DirEntryStat *l_stat = NULL;
        ...
        d_entry = (Rpc__DirEntry *) malloc(sizeof *d_entry);
        s_stat = (Rpc__DirEntryStat *) malloc(sizeof *s_stat);
        l_stat = (Rpc__DirEntryStat *) malloc(sizeof *l_stat);
        CHECK(d_entry && s_stat && l_stat);

        rpc__dir_entry__init(d_entry);
        rpc__dir_entry_stat__init(s_stat);
    ...
    if (reply_list_dir) {
        if (reply_list_dir->dir_entries) {
            for (size_t i = 0; i < reply_list_dir->n_dir_entries; ++i) {
                if (!reply_list_dir->dir_entries[i]) {
                    continue;
                }
 ...
 *               This should be a message of type Rpc__RequestExec.
 ...
 */
static routine_status_t routine_exec(const ProtobufCMessage *in_msg, ProtobufCMessage **out_msg) {
    const Rpc__RequestExec *request_exec = (const Rpc__RequestExec *) in_msg;
    Rpc__ReplyExec *reply_exec = malloc(sizeof *reply_exec);
    pid_t pid = INVALID_PID;

    CHECK(reply_exec != NULL);

    rpc__reply_exec__init(reply_exec);
...
/**
 * Frees resources associated with a ProtobufCMessage of type Rpc__ReplyPeek.
 *
 ...
 *              Expected to be of type Rpc__ReplyPeek.
 */
static void cleanup_peek(ProtobufCMessage *reply) {
    Rpc__ReplyPeek *reply_peek = (Rpc__ReplyPeek *) reply;
 ...
 *
 * @param reply A pointer to a ProtobufCMessage structure cast to Rpc__ReplyListDir.
 ...
 */
static void cleanup_listdir(ProtobufCMessage *reply) {
    Rpc__ReplyListDir *reply_list_dir = (Rpc__ReplyListDir *) reply;
    if (!reply_list_dir || !reply_list_dir->dir_entries) {
        return;
    }
    for (size_t i = 0; i < reply_list_dir->n_dir_entries; ++i) {
        Rpc__DirEntry *e = reply_list_dir->dir_entries[i];
        if (!e) {
            continue;
        }
        if (e->d_name) {
